      ...
      <div className="max-w-6xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-green-600 to-emerald-600 p-8 text-white flex flex-col md:flex-row items-center md:items-end justify-between">
          ...
          <div className="mt-4 md:mt-0 flex space-x-3">
            <button className="px-4 py-2 bg-white text-green-600 rounded-lg font-medium hover:bg-green-50 shadow">
              Edit Profile
            </button>
            <button className="px-4 py-2 bg-green-800 text-white rounded-lg font-medium hover:bg-green-700 shadow">
              Download PDF
            </button>
          </div>
        </div>
